jQuery(document).ready(function($){
	...
	$('.amountonly').bind('paste', function() {
		var el = this;
		setTimeout(function() {
	...
	$(document.body).on('keypress',".decimalonly",function(event){
		 var $this = $(this);
		 var $upto = (typeof $(this).attr("data-precision") =="undefined")?4:$(this).attr("data-precision");
	...
	$(document.body).on('paste',".decimalonly", function(e){
		...
		var $upto =($(this).attr("data-precision") =="undefined")?4:$(this).attr("data-precision");
		if ($.isNumeric(text)) {
