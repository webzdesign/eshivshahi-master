...

{
    ...
    protected $fillable = [
        ...
        'relevant_agreement','route_id','scheduled_time','depot_id','division_id', 'billing_period','vendor_id','voucher_no','voucher_date','vehicle_id_reff','vehicle_id','date','kms','diesel_ltr','diese_per_ltr_price','adblue','adblue_price','breaddown_charge','breaddown_charge_value','vor_exp','parking_exp','hault_tax','wash_exp','other_exp','total_km','diesel_as_per_gov','extra_filled_diesel','extra_diesel_charged','remarks','status','from_date','to_date','delete_status','vendorinvoice_id','created_by','updated_by','idling_minutes','is_parisishtha_a_created','schedule_complete'
