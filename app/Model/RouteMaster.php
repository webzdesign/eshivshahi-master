...
{
    protected $fillable = [
       'division_id', 'from_depot', 'to_depot', 'to_division', 'scheduled_km', 'trip_hrs', 'trip_min','scheduled_time', 'scheduled_number', 'maximum_ideling_minutes', 'status', 'created_at', 'updated_at'
    ];
