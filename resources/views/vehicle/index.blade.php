            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    <label class=" col-md-3 col-sm-3 col-xs-12" >Divison<span class=" required"> *</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    <label class=" col-md-3 col-sm-3 col-xs-12" >Depot<span class=" required"> *</span></label >
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <select  id="depot_id" name="depot_id"  class="form-control select2_single col-md-7 col-xs-12 depot_id" style="width:100%;">
                          <option value=""></option>
							...
							@endforeach
                        <select>
                       <!-- <input type="hidden" name="depot_id" value="$user->depot_id">-->
                       <input type="hidden" name="hidden_depot_id" id="hidden_depot_id" value="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                      <label><input type="radio" class="status" name="status" id="active_status" value="" checked />Active</label> &nbsp;
                      <label> <input type="radio" class="status" name="status" id="inactive_status" value="" />
                   Inactive</label>
                  </div>
                </div>
                <div class="form-group">
  ...
  jQuery(document).ready(function() {
    ...
    docdatatable=$('#datatable-responsive').DataTable({
      ...
      columns: [
            ...
            { data: 'division.name',orderable: false },
            { data: 'depot.name' ,orderable: false},
            { data: 'vehicle_no' },
            { data: 'bus_type' },
            { data: 'status' },
