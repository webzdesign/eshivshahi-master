                                            ...
                                            @for($i=0;$i<count($date);$i++)
                                                @if($date[$i] > date('Y-m-d'))
                                                    <tr class="parishishtha_b">
                                                        ...
                                                        <td align="center"><input type="checkbox" disabled name="p_k[{{$i}}]" class="p_k" id="p_k[{{$i}}]" value="1" style="height:25px;width:25px;" {{($p_k[$i]==1)?'checked':'' }}><input type="hidden" name="p_k_v[{{$i}}]" class="p_k_v" id="p_k_V[{{$i}}]" value="{{ $p_k[$i]}}"></td>
                                                ...
                                                @else
                                                    ...
                                                    <tr_v class="parishishtha_b">
                                                        ...
                                                        <td align="center"><input type="checkbox" disabled name="schedule_complete[{{$i}}]" class="schedule_complete" id="schedule_complete[{{$i}}]" value="1" style="height:25px;width:25px;" {{($schedule_complete[$i]==1)?'checked':'' }}><input type="hidden" name="s_c_v[{{$i}}]" class="s_c_v" id="s_c_V[{{$i}}]" value="{{ $schedule_complete[$i]}}"></td>
...
//                calulateentry(Days+1);
    ...
    /*jQuery.validator.addMethod(
        ...
        function(value, element) {
            ...
            var th = $(element).closest('tr');

            var dt = th.find('.date_pb').val();
            ...
            $.ajax({
                ...
                data:{ vechicle_no:value,from_date:$("#from_date").val(),to_date:$("#to").val(),dt:dt,id:$("#id").val()
        ...
        "Bus is already in use cannot be used here."
...

  {
    ...
    var flg = 0;
        ...
        /* var $veh = $clone.find(".vehicle_id"); */

            /* console.log($veh.attr("id")); */
...

            {
                ...
                /* jQuery(".vehicle_id").each(function(i, v){
             ...
             $('#frm_single').validate({
...

                {
...

                    {
                       ...
                       /* vehiclevalidate: "Bus is already in use cannot be used here."*/
