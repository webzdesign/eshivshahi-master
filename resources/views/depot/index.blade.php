            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select  class="textonly form-control select2_single division_id" style="width:100%;" name="division_id" id="division_id">
                      <option value=""></option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="textonly form-control" name="name" id="name" value="" placeholder="Enter Name"/>
                  </div>
                </div>
                <div class="form-group">
