					...
					$('.kms').each(function (){
                     ...
                     $('.parking_exp').each(function (){
                        ...
                        if(kms_er != '-1'){
                            ...
                            if(vehicle_er != '-1'){
                                var str = 'Please Enter Vehicle For All Field';
                                var result = str.fontcolor("red");
