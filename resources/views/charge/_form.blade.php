            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="frm_charge" method="post"  action ="{{route('charges.update',$charges->id)}}" class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="diesel_rate" name="diesel_rate" class="form-control col-md-7 col-xs-12 focusClass amountonly" placeholder="Enter Diesel Rate" value="{{$charges->diesel_rate}}" >
                                ...
                                <tbody>
				                   ...
				                   @foreach($vor_arr as $key=>$val)
                                    <tr class="vor_chargesdetail">
                                        <td>
                                            <input id="vor_charges" placeholder="0" name="vor_charges[]"  class="form-control col-md-7 col-xs-12 box focusClass amountonly" value="{{$val}}">
                            ...
                            <table  class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="washing_chargesdetail">
                                        <td>
                                            <input id="washing_charges" placeholder="0" name="washing_charges[]"  class="form-control col-md-7 col-xs-12 box focusClass amountonly" value="{{$val}}">
                            ...
                            <table  class="table table-bordered" >
                                ...
                                <tbody>
                                    ...
                                    <tr class="parking_chargesdetail">
                                        <td>
                                            <input id="parking_charges" placeholder="0" name="parking_charges[]"  class="form-control col-md-7 col-xs-12 box focusClass amountonly" value="{{$val}}">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success focusClass">Update</button>
                        </div>
                    </div>
