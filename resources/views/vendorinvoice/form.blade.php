				...
				<div class="x_panel">
					...
					<form id="frm_single" method="post" autocomplete="off" action ="{{$route}}" class="form-horizontal form-label-left">
                                ...
                                <select id="vendor_id" name="vendor_id" style="width:100%;"  class="form-control col-md-7 col-xs-12 select2_single vendor_id" @if(Auth::user()->usertype_id !=1){{'disabled'}} @endif >
                                    <option value=""></option>
                                        @foreach($vendors as $vendorVal)
                                            <option @if($vendor_id != '') {{ ($vendor_id == $vendorVal->id) ? 'selected' : '' }}  @endif  value="{{ $vendorVal->id}}">{{ $vendorVal->vendor_name}}</option>
                                        @endforeach
                                        @if($vendor_id != '')
                                        <input type="hidden" id="hidden_vendor_id" name="vendor_id" value="{{ $vendor_id }}">
                                        @endif
                                </select>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="division_id" name="division_id"  class="form-control select2_single col-md-7 col-xs-12 division_id" style="width:100%;">
                                    ...
                                    @foreach($division as $key=>$val)
                                        <option value="{{ $val->id }}" {{ ($val->id == $userdivision) ? 'selected' : '' }}>{{ $val->name }}</option>
                                    @endforeach
                                <select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select id="depot_id" name="depot_id"  class="form-control select2_single col-md-7 col-xs-12 depot_id" style="width:100%;">
                                    ...
                                    @foreach($depots as $key=>$val)
                                        <option value="{{ $val->id }}" {{ ($val->id == $userdepo) ? 'selected' : '' }} >{{ $val->name }}</option>
                                    @endforeach
                                <select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class=" col-md-3 col-sm-3 col-xs-12">
                                <input type="text" name="to" id="to" class="datepicker form-control" placeholder="To Date"  />
                            </div>
                        </div>
                                ...
                                <table id="parishishtha_b" class="table table-bordered dttable" style="width:1490px;">
                                    ...
                                    <tbody style="">
                                        <tr class="parishishtha_b">
                                            ...
                                            <td><input type="text" data-precision="2" id="diesel_ltr[0]" name="diesel_ltr[0]"  class="decimalonly form-control  diesel_ltr diesel_ltr_auto">
                                            </td>

                                            <td><input type="text" id="diese_per_ltr_price[0]" name="diese_per_ltr_price[0]"  class="form-control  diese_per_ltr_price decimalonly diese_per_ltr_price_auto" data-precision="2" value="{{$default_diseal->diesel_rate}}">
                                            </td>

                                            <td><input type="text" id="adblue[0]" name="adblue[0]"  class="form-control adblue decimalonly adblue_auto" data-precision="2">
                                            </td>

                                            <td><input type="text" id="adblue_price[0]" name="adblue_price[0]"  class="form-control  adblue_price decimalonly adblue_price_auto" data-precision="2">
                                            </td>
                                            ...
                                            <?php $vor_exps = explode(",",$default_diseal->vor_charges); ?>
                                                <select  id="vor_exp[0]" name="vor_exp[0]"  class="form-control select2_single col-md-7 col-xs-12 vor_exp" style="width:100%;">
                                                    ...
                                                    <option value="{{$vor_exp}}">{{$vor_exp}}    @endforeach
                                                    <select>
                                            </td>
                                            <td>
                                            ...
                                            <td><input type="text" id="hault_exp[0]" name="hault_exp[0]"  class=" numberonly form-control  hault_exp hault_exp_auto">
                                            </td>
                                            ...
                                            <td><input type="text" id="other_exp[0]" name="other_exp[0]"  class=" numberonly form-control  other_exp other_exp_auto">
                                            </td>
                                           ...
                                           <?php /*<input type="text" id="vehicle_id[0]" name="vehicle_id[0]"  class="form-control  vehicle_id vehicle_id_auto">*/ ?>
                                            ...
                                            <td>
                                            <textarea rows="1" id="remarks[0]" name="remarks[0]"  class="form-control  remarks "></textarea></td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control total_adblue" name="total_adblue" id="total_adblue" readonly></td>

                                            <td></td>

                                            <td><input type="text" class="form-control total_breaddown_charge" name="total_breaddown_charge" id="total_breaddown_charge" readonly></td>

                                            <td><input type="text" class="form-control total_vor_exp" name="total_vor_exp" id="total_vor_exp" readonly></td>

                                            <td><input type="text" class="form-control" name="total_parking_exp" id="total_parking_exp" readonly></td>

                                            <td><input type="text" class="form-control total_hault_exp" name="total_hault_exp" id="total_hault_exp" readonly>
                                            </td>

                                            <td><input type="text" class="form-control total_wash_exp" name="total_wash_exp" id="total_wash_exp" readonly></td>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><input readonly type="text" data-precision="2" class="decimalonly form-control"  name="gov_diesel" id="gov_diesel" ></td>
                            ...
                            <tr>
                                ...
                                <td width="10%"><input type="text" class="form-control total_amount amountonly" name="total_amount" id="total_amount" readonly ></td>
                            </tr>
                            <tr>
                                <th colspan="3" style="text-align:right;">Total Deduction</th>
                                <td width="10%"><input type="text" class="form-control total_charge amountonly" name="total_charge" id="total_charge" readonly ></td>
                            </tr>
                            <tr>
                                <th colspan="3" style="text-align:right;"><span style="font-size:20px;">Grand Total</span></th>
                                <td width="10%"><input type="text" class="form-control grand_amount amountonly" name="grand_amount" id="grand_amount" readonly ></td>
                            </tr>
                        </table>
