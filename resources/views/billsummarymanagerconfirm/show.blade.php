                    ...
                    @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <a href="{{url('showparisishthb/'.$billsummary[0]->bill_no)}}" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <a href="{{url('showparisishthaa/'.$billsummary[0]->bill_no)}}" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View</a>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive" style="width:100%;margin: 0 auto;">
                            <table border="1" class="table table-bordered dttable" cellspacing="0" style="width:1700px;">
                                ...
                                <tr>
                                    ...
                                    <th colspan="1"><input type="text" class="form-control" id="tds" readonly value="{{ $billsummary[0]->tds }}" /></th>
                                </tr>
                                <tr>
                                    <th colspan="10"></th>
                                    <th style="text-align:center;"> - </th>
                                    <th style="text-align:center;" colspan="2">Grand Total</th>
                                    <th colspan="1"><input type="text" class="form-control" id="amountafter_tds" readonly value="{{ $billsummary[0]->amount_after_tds }}" /></th>
                                </tr>
                            </table>
                            </div>
