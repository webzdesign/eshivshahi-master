...
@if($action=='insert')
    ...
    @php  $route=route('routemaster.store'); @endphp
...
@php  $redirect = $route; @endphp
    ...
    @php  $route=route('routemaster.update',Crypt::encryptString($routemaster->id)); @endphp
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <form class="form-horizontal" id="frm" method="POST" action="{{$route}}" autocomplete="off">
                      ...
                      <tbody>
                        ...
                        @if($action =='insert')
                          ...
                          @else
                            ...
                            @php $s_time=explode("*++*",$routemaster->scheduled_time); @endphp

                            @foreach($s_time as $k=>$s)

                              <tr class="scheduled_time">

                                <td>

                                  <input type="text" class="form-control numberonly s_time" name="s_time[{{$k}}]" id="s_time[{{$k}}]" value="{{date('H:i',strtotime($s)) }}" placeholder="Timing" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="submit" id="form_btn" value="{{$btn}}" class="btn  btn-primary"/>
  ...
  $('#frm').validate({
...

    {
      ...
      /*  remote:{
          ...
          url:"{{url('checkmaxIdelingMinutes')}}",

          data:{

            name:function(){

              return $("#maximum_ideling_minutes").val();
